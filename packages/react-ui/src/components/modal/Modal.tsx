...
export const Modal = forwardRef<HTMLDivElement, ModalProps>(
  (
    ...
    const [statiBackdrop, setStatiBackdrop] = useState(false)
    ...
    useLayoutEffect(() => {
      ...
      setTimeout(() => setStatiBackdrop(false), duration)
    }, [statiBackdrop])
    ...
    return (
      <>
        ...
        {typeof window !== 'undefined' && portal
          ? backdrop && createPortal(<Backdrop visible={_visible} />, document.body)
          : backdrop && <Backdrop visible={_visible} />}
      </>
    )
  },
)
