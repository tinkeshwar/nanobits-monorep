...
export interface DropdownProps extends HTMLAttributes<HTMLDivElement | HTMLLIElement> {
  /**
...
interface ContextProps extends DropdownProps {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  dropdownToggleRef: RefObject<any> | undefined
  setVisible: React.Dispatch<React.SetStateAction<boolean | undefined>>
}

export const DropdownContext = createContext({} as ContextProps)

export const Dropdown = forwardRef<HTMLDivElement | HTMLLIElement, DropdownProps>(
  (
    {
      children,
      alignment,
